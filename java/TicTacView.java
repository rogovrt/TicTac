...
public class TicTacView extends HBox {
    ...
    private void initStatField() {
        ...
        res1.textProperty().bind(ticTacViewModel.stat1Property().asString());
        Label res2 = new Label();
        res2.resize(80, 10);
        res2.textProperty().bind(ticTacViewModel.stat2Property().asString());
        p1.textProperty().bindBidirectional(ticTacViewModel.winner1Property());
        p2.textProperty().bindBidirectional(ticTacViewModel.winner2Property());
